...
else 
{
	...
	<html>
		...
		<title>Introduction - Poppy</title>
	...
	if ($result = mysqli_query($conn, $sql))
	{
		...
		<?php
			...
			<form class="form col-md-12 center-block alertSubmit" id = "firstForm" action ="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" >
			<?php
			
			echo "<h2 class=\"text-center heading\">Congratulations!</h2>";
